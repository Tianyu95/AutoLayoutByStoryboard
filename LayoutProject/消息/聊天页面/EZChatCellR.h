...
@protocol EZChatCellRDelegate <NSObject>
...
@interface EZChatCellR : UITableViewCell <MLEmojiLabelDelegate, UITextViewDelegate, UIGestureRecognizerDelegate,EZAVAudioPlayerDelegate>
{
    BOOL contentVoiceIsPlaying;
    EZAVAudioPlayer *audio;
}
@property (nonatomic, assign) id <EZChatCellRDelegate> delegate;
