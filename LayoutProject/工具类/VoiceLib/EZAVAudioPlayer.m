...
@interface EZAVAudioPlayer ()<AVAudioPlayerDelegate>

@end

@implementation EZAVAudioPlayer

+ (EZAVAudioPlayer *)sharedInstance
{
    static EZAVAudioPlayer *sharedInstance = nil;
...
-(void)playSongWithUrl:(NSString *)songUrl
{
    ...
    dispatch_async(dispatch_queue_create("playSoundFromUrl", NULL), ^{
        [self.delegate EZAVAudioPlayerBeiginLoadVoice];
...
-(void)playSoundWithData:(NSData *)soundData{
    ...
    [_player play];
    [self.delegate EZAVAudioPlayerBeiginPlay];
}
...
{
    [self.delegate EZAVAudioPlayerDidFinishPlay];
}
